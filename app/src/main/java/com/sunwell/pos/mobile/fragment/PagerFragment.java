...
public class PagerFragment<T> extends Fragment
{
...
//    private NamedObjectTranslator<T> translator;
    ...
    public static <V> PagerFragment newInstance(RecycleViewAdapter<V, ? extends RecyclerView.ViewHolder> _adapter, int _objPerPage) {
        ...
        PagerFragment<V> fragment = new PagerFragment<>();
