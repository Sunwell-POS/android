...
public class InvoiceFragment_old3 extends Fragment {
    ...
    public static InvoiceFragment_old3 newInstance(SalesInvoice _si) {
        Log.d(Util.APP_TAG, "CALL NEW INST");
        Bundle bundle = new Bundle();
        bundle.putSerializable(InvoiceFragment_old3.SALES_INVOICE, _si);
        InvoiceFragment_old3 fragment = new InvoiceFragment_old3();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        try {
            ...
            argSI = arguments != null ? (SalesInvoice) arguments.get(InvoiceFragment_old3.SALES_INVOICE) : null ;
            ...
            if (_requestCode == Util.REQUEST_CODE_ADD) {
                ...
                if (_resultCode == Util.RESULT_CODE_SUCCESS) {
                    ...
                    if (dialogListener != null)
                        dialogListener.onResult(InvoiceFragment_old3.this, salesPayment);
                    else
                ...
                holder.imageProduct.setOnClickListener(
                        new View.OnClickListener()
                        {
                            ...
                            public void onClick(View v)
                            {
                                ...
                                dialog.setTargetFragment(InvoiceFragment_old3.this, Util.REQUEST_CODE_ADD);
                                dialog.show(getFragmentManager(), "salesinvoiceline");
                            }
                        }
                );

                Log.d(Util.APP_TAG, "QUEUE IMAGe REQUEST: " + InvoiceFragment_old3.this + " position: " + position);
