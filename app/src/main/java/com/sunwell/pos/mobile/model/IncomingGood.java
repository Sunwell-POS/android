...
public class IncomingGood implements Serializable
{
    ...
    public IncomingGood(Product _p, Warehouse _w) {
        product = _p;
        warehouse = _w;
    }
    ...
    public void setIncomingDate(Date _incomingDate)
    {
    ...
    public boolean equals(Object _obj) {
        if(! (_obj instanceof IncomingGood))
            return false;

        IncomingGood ic = (IncomingGood) _obj;
